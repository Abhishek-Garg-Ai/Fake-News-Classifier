...
def predict(text):
    ...
    test_df = pd.DataFrame({"summary": summary_lt})
    test_df['summary']=test_df['summary'].apply(cleanHtml)
    test_df['summary']=test_df['summary'].apply(cleanPunc)
    test_df['summary']=test_df['summary'].apply(keepAlpha)
    test_df['summary']=test_df['summary'].apply(removeStopWords)
